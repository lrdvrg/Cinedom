                ...
                <form name="sentMessage" id="loginForm" novalidate>
                    <div class="control-group">
                        ...
                        <div class="form-group floating-label-form-group controls">
                            <label>Nombre</label>
                            <input type="text" class="form-control" placeholder="Nombre" id="nombre" required data-validation-required-message="Debe ingresar su nombre">
                            <p class="help-block text-danger"></p>
                        </div>

                        <div class="form-group floating-label-form-group controls">
                            <label>Correo electronico</label>
                            <input type="text" class="form-control" placeholder="Correo electronico" id="correoelectronico" required data-validation-required-message="Debe ingresar su correo electronico">
                            <p class="help-block text-danger"></p>
                        </div>

                        <div class="form-group floating-label-form-group controls">
                            <label>Numero de telefono</label>
                            <input type="number" class="form-control" placeholder="Numero de telefono" id="telefono" required data-validation-required-message="Debe ingresar su numero de telefono">
                            <p class="help-block text-danger"></p>
                        </div>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-outline-primary btn-block" id="sendMessageButton">Registrarte</button>
                    </div>
                </form>
